...
const satchelItems = document.getElementsByClassName("satchel-items");
...
function placeItem(url) {
  ...
  while (getComputedStyle(newItems[k]).backgroundImage != "none") {
    k++;
  }
...
function offer() {
  ...
  while (getComputedStyle(tradeItems[i]).backgroundImage != "none") {
    tradeItems[i].style.border = "3px solid blue";
    i++;
  }
...
function executeTrade() {
  console.log("Execute Trade working");

  n = 0;

  while (getComputedStyle(tradeItems[n]).backgroundImage != "none") {
    console.log(getComputedStyle(tradeItems[n]).backgroundImage);
    let theItem = getComputedStyle(tradeItems[n]).backgroundImage;
    loopSatchel(theItem);
    n++;
  }
}
...
function loopSatchel(theItem) {
  console.log("loop satchel working");

  o = 0;

  while (getComputedStyle(satchelItems[o]).backgroundImage != "none") {
    o++;
  }

  satchelItems[o].style.backgroundImage = theItem;
  satchelItems[o].style.backgroundPosition = "center";
  satchelItems[o].style.backgroundRepeat = "no-repeat";
  satchelItems[o].style.backgroundSize = "cover";
}

//   for (o = 0; o < satchelItems.length; o++) {
//     console.log(satchelItems[o]);

//     if (getComputedStyle(satchelItems[o]).backgroundImage === "none") {
